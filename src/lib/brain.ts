...
export const brainOverview = {
  ...
  privacyMode: 'Private inference and voice on your Mac',
...
export const brainLayers: BrainLayer[] = [
  ...
  },
  {
    ...
    models: [
      { id: 'local-llm', name: 'Local LLM Composer', purpose: 'Writes the daily snapshot, weekly reflections, and therapist responses.', status: 'active', versionAdded: 'v2.2' },
